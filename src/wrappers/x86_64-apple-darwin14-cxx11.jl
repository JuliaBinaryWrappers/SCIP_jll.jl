# Autogenerated wrapper script for SCIP_jll for x86_64-apple-darwin14-cxx11
export libscip
...
const libscip_splitpath = ["lib", "libscip.7.0.dylib"]
...
const libscip = "@rpath/libscip.7.0.dylib"
