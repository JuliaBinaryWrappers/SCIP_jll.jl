...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SCIP_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("e5ac4fe4-a920-5659-9bf8-f9f73e9e79ce"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SCIP", artifacts_toml) for e in artifacts["SCIP"]]
...
if best_platform === nothing
    @debug("Unable to load SCIP; unsupported platform $(triplet(platform_key_abi()))")
else
