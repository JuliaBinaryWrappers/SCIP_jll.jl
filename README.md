# `SCIP_jll.jl` (v900.200.100+1)

[![deps](https://juliahub.com/docs/SCIP_jll/deps.svg)](https://juliahub.com/ui/Packages/General/SCIP_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/2940018efacd978144ab5cb4931010a4e4cfdee9/S/SCIP/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
